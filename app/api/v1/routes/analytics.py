...
def get_main_themes(
    ...
    return analytics_service.get_main_themes(session, current_user.id, start_date, end_date)
...
def get_best_and_worst_day(
    ...
    return analytics_service.get_best_and_worst_entries_by_mood_rating(session, current_user.id, start_date, end_date)
...
def compare_current_and_previous_month_mood_rating(
    ...
    return analytics_service.compare_current_and_previous_month_mood_rating(session, current_user.id)
